    ...
    loadBuildingTypes() {
        const buildingDefinitions = [
            ...
            // ===== YURI BUILDINGS =====
            {
                ...
                width: 96,
                height: 96,
                canBuild: ['bio_reactor', 'slave_miner', 'barracks', 'war_factory', 'sub_pen', 'radar_tower'],
                description: 'Primary construction facility for Yuri\'s army.'
            },
            {
                type: 'bio_reactor',
                name: 'Bio-Reactor',
                ...
                canGarrison: 5,
                powerPerGarrison: 20,
                description: 'Generates power. Garrison infantry inside to increase power output.'
            },
            {
                type: 'slave_miner',
                name: 'Slave Miner',
                ...
                height: 80,
                processesOre: true,
                includesHarvester: 'slave',
                harvesterCount: 5,
                description: 'Processes ore into credits. Comes with 5 Slaves.'
            },
            {
                type: 'barracks',
                name: 'Yuri Barracks',
                ...
                width: 64,
                height: 64,
                canProduce: ['initiate', 'engineer', 'brute', 'yuri_clone', 'yuri_prime'],
                description: 'Trains Yuri\'s psychic and genetically-engineered infantry.'
            },
            {
                type: 'war_factory',
                ...
                width: 96,
                height: 96,
                canProduce: ['lasher_tank', 'gattling_tank', 'magnetron', 'mastermind', 'slave'],
                description: 'Produces Yuri\'s ground vehicles.'
            },
            {
                type: 'sub_pen',
                name: 'Submarine Pen',
                ...
                height: 64,
                requiresWater: true,
                canProduce: ['boomer_sub'],
                description: 'Constructs Yuri\'s naval vessels.'
            },
            {
                type: 'radar_tower',
                name: 'Yuri Radar Tower',
                faction: 'yuri',
                cost: 1000,
                buildTime: 25,
                health: 1000,
                ...
                height: 48,
                providesRadar: true,
                description: 'Provides radar for Yuri\'s forces.'
            },
            {
                type: 'grinder',
                name: 'Grinder',
                ...
                width: 64,
                height: 64,
                canRecycleUnits: true,
                description: 'Recycle your own units here to get a full refund.'
            },
            {
                type: 'battle_lab',
                ...
                width: 80,
                height: 80,
                enablesUnits: ['yuri_prime', 'mastermind', 'floating_disc'],
                enablesBuildings: ['psychic_dominator', 'genetic_mutator', 'cloning_vats'],
                description: 'Enables advanced Yuri technology.'
            },
            {
                type: 'cloning_vats',
                name: 'Cloning Vats',
                ...
                height: 80,
                clonesInfantry: true,
                description: 'Creates a free copy of any infantry trained at the Barracks.'
            },
            {
                type: 'psychic_dominator',
                ...
                description: 'Superweapon that permanently mind-controls a group of enemy units.'
            },
            {
                type: 'genetic_mutator',
                ...
                description: 'Superweapon that transforms enemy infantry in an area into Brutes.'
            },
            {
                type: 'gattling_cannon',
                ...
                antiAir: true,
                rampingDamage: true,
                description: 'Defensive turret that is effective against infantry and aircraft.'
            },
            {
                type: 'psychic_tower',
                name: 'Psychic Tower',
                ...
                description: 'Defensive tower that mind-controls up to 3 approaching enemy units.'
            },
            {
                type: 'tank_bunker',
                name: 'Tank Bunker',
                ...
                isDefense: true,
                canGarrison: 1,
                garrisonType: 'vehicle',
                description: 'A heavily armored bunker that can be garrisoned by a single vehicle.'
            },
